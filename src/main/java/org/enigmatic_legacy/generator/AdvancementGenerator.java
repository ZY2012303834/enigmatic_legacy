...
public class AdvancementGenerator implements DataProvider {
    ...
    private static List<AdvancementSpec> advancements() {
        ...
        advancements.add(AdvancementSpec.hidden("main/discover_spellstone", ROOT, "golem_heart", "discoverSpellstone", 0.0F, -1.0F, "task",
                "golem_heart", "angel_blessing", "ocean_stone", "blazing_core", "forgotten_ice", "revival_leaf", "eye_of_nebula", "void_pearl", "the_cube", "heart_of_creation"));
        ...
        advancements.add(AdvancementSpec.framed("main/malice_totem", "main/twisted_heart", "totem_of_malice", "maliceTotem", 4.0F, 4.0F, "challenge"));

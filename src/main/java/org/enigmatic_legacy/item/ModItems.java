...
public final class ModItems {
    ...
    public static final DeferredItem<SanguinaryHandbook> SANGUINARY_HANDBOOK = ITEMS.register("sanguinary_handbook", SanguinaryHandbook::new);
    public static final DeferredItem<AntiqueBookBag> ANTIQUE_BOOK_BAG = ITEMS.register("antique_book_bag", AntiqueBookBag::new);
...
// 复刻自 Enigmatic Addons 的 scorched_charm。
    ...
    public static final DeferredItem<ForgottenIceCrystal> FORGOTTEN_ICE_CRYSTAL = ITEMS.register("forgotten_ice", ForgottenIceCrystal::new); // 忘却冰晶
    public static final DeferredItem<EtheriumCore> ETHERIUM_CORE = ITEMS.register("etherium_core", EtheriumCore::new); // 以太核心
    ...
    public static final DeferredItem<ScrollOfIgnoranceCurse> CURSED_XP_SCROLL = ITEMS.register("cursed_xp_scroll", ScrollOfIgnoranceCurse::new); // 无知诅咒卷轴
